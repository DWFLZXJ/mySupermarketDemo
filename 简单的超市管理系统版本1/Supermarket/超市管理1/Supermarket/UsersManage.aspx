<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersManage.aspx.cs" Inherits="Supermarket.UsersManage" %>
    ...
    <script  language="javascript" type="text/javascript">
        $(function () {
            $("#btnAdd").click(function () { //点击事件
                ...
                $.ajax({
                    url: "CommodityUserManageHandler.ashx",
                    type: "POST",
