<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommoditySortManage.aspx.cs" Inherits="Supermarket.CommoditySortManage" %>
...
<body>
    ...
    <asp:GridView ID="gvSortName" runat="server" AutoGenerateColumns="False">
        <Columns>
